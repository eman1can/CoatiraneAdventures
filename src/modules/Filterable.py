...
class FilterWidget(Widget):
    def __init__(self, **kwargs):
        ...
        self.magical = HCButton(size=button_size, size_hint=(None, None), border=[0, 0, 0, 0], path="../res/screens/buttons/long_toggle", text="    Magical", font_size=button_size[1] * 0.45, font_name="../res/fnt/Gabriola.ttf", color=(0, 0, 0, 1), toggle_state=True)
        self.physical = HCButton(size=button_size, size_hint=(None, None), border=[0, 0, 0, 0], path="../res/screens/buttons/long_toggle", text="    Physical", font_size=button_size[1] * 0.45, font_name="../res/fnt/Gabriola.ttf", color=(0, 0, 0, 1), toggle_state=True)
        self.balanced = HCButton(size=button_size, size_hint=(None, None), border=[0, 0, 0, 0], path="../res/screens/buttons/long_toggle", text="      Balanced", font_size=button_size[1] * 0.45, font_name="../res/fnt/Gabriola.ttf", color=(0, 0, 0, 1), toggle_state=True)
        self.defensive = HCButton(size=button_size, size_hint=(None, None), border=[0, 0, 0, 0], path="../res/screens/buttons/long_toggle", text="       Defensive", font_size=button_size[1] * 0.45, font_name="../res/fnt/Gabriola.ttf", color=(0, 0, 0, 1), toggle_state=True)
        self.healing = HCButton(size=button_size, size_hint=(None, None), border=[0, 0, 0, 0], path="../res/screens/buttons/long_toggle", text="    Healing", font_size=button_size[1] * 0.45, font_name="../res/fnt/Gabriola.ttf", color=(0, 0, 0, 1), toggle_state=True)
