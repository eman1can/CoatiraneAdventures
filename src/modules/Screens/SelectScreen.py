...
class SelectScreen(Screen):
    ...
    def __init__(self, main_screen, **kwargs):
        ...
        self.title = Label(text="Select a Character!", size_hint=(None, None), color=(.8, .8, .8, 1), font_name='../res/fnt/Precious.ttf')

        self.newgamebell = HTButton(size_hint=(None, None), path='../res/screens/buttons/newgame.bell')
        self.newgamebell.bind(on_touch_down=lambda instance, touch: self.chooseCharacter(instance, touch, 'hero_bell'))
        self.newgameais = HTButton(size_hint=(None, None), path='../res/screens/buttons/newgame.ais')
        self.newgameais.bind(on_touch_down=lambda instance, touch: (self.chooseCharacter(instance, touch, 'badass_ais')))

        self.newgamebell_label = Label(text="Rabbit Foot", size_hint=(None, None), color=(1, 1, 1, 1), font_name='../res/fnt/Precious.ttf')
        self.newgameais_label = Label(text="Battle Princess", size_hint=(None, None), color=(1, 1, 1, 1), font_name='../res/fnt/Precious.ttf')
    ...
    def on_size(self, *args):
        ...
        self.newgamebell_label.texture_update()
        self.newgamebell_label.size = self.newgamebell_label.texture_size
        ...
        self.newgameais_label.texture_update()
        self.newgameais_label.size = self.newgameais_label.texture_size
