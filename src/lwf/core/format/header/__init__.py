__all__ = ('Header', 'HeaderCompat',)

from .compat import HeaderCompat
...
class Header:
    ...
    def __str__(self):
        return f"Header <Width: {self.width}, Height: {self.height}, Frame Rate: {self.frame_rate}, Root Movie Id: {self.root_movie_id}, Name String Id: {self.name_string_id}, Background Color: {self.background_color}"
