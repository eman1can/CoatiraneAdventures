...
class Object:
    ...
    def is_button(self):
        return self.type == ObjectType.BUTTON

    def is_movie(self):
        return self.type == ObjectType.MOVIE or self.type == ObjectType.ATTACHED_MOVIE

    def is_particle(self):
        return self.type == ObjectType.PARTICLE

    def is_program_object(self):
        return self.type == ObjectType.PROGRAM_OBJECT

    def is_text(self):
        return self.type == ObjectType.TEXT
