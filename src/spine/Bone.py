...
class Bone(object):
    ...
    def updateWorldTransform(self, flipX, flipY, sscaleX, sscaleY):
        if self.parent:
            ...
            self.worldScaleX = self.parent.worldScaleX * self.scaleX * sscaleX
            self.worldScaleY = self.parent.worldScaleY * self.scaleY * sscaleY
            self.worldRotation = self.parent.worldRotation + self.rotation
        else:
            self.worldX = self.x
            self.worldY = self.y
            self.worldScaleX = self.scaleX * sscaleX
            self.worldScaleY = self.scaleY * sscaleY
