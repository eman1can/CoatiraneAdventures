...
class FamilyDomain(Screen):
    ...
    def goto_next(self):
        Refs.gs.display_screen('select_start', True, True, self.save_slot, self.god_name, self.gender, self.symbol_id, self.ids.domain_wheel.widgets[0].domain.get_title())
