...
from text.screens.screen_names import BACK, CRAFTING_PROCESS_MATERIALS, CRAFT_ITEM_MULTIPLE
...
def get_screen(console, screen_data):
    ...
    ip_text, ip_options = item_page_list(1, CRAFTING_PROCESS_MATERIALS, page_num, recipes, fail, '', item_func)
