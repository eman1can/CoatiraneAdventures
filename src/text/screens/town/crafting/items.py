...
from text.screens.screen_names import BACK, CRAFTING_ITEMS, CRAFT_ITEM_MULTIPLE
...
def get_screen(console, screen_data):
    ...
    recipes = Refs.gc.get_item_recipes()
    ...
    ip_text, ip_options = item_page_list(1, CRAFTING_ITEMS, page_num, recipes, fail, '', item_func)
