...
from spine import Attachment
class MeshAttachment(Attachment.Attachment):
    pass
class SkinnedMeshAttachment(Attachment.Attachment):
    pass
class BoundingBoxAttachment(Attachment.Attachment):
    pass
class RegionAttachment(Attachment.Attachment):
    def __init__(self):
        super(RegionAttachment, self).__init__()
        print("New region attachment")
        self.x = 0.0
        self.y = 0.0
        self.scaleX = 1.0
        self.scaleY = 1.0
